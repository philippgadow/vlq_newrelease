...
get_vlqcoupling = subprocess.Popen(['get_files', '-jo', 'VLQCouplingCalculator_v3.py'])
if get_vlqcoupling.wait():
    print "Could not copy VLQCouplingCalculator_v3.py"
    sys.exit(2)

get_lhehacker = subprocess.Popen(['get_files', '-jo', 'lhe_hacker_v3.py'])
if get_lhehacker.wait():
    print "Could not copy lhe_hacker_v3.py"
    sys.exit(2)

from VLQCouplingCalculator_v3 import *
from lhe_hacker_v3 import *
...
def paramdictmaker():
    ...
    if runArgs.vlqmode in ['X', 'Y']:
        ...
        # paramdict['k'+runArgs.vlqmode.lower()+chiralityIndex.lower()+'w']['K' + runArgs.vlqmode + chiralityIndex + '2'] = '0.00000'
        # paramdict['k'+runArgs.vlqmode.lower()+chiralityIndex.lower()+'w']['K' + runArgs.vlqmode + chiralityIndex + '1'] = '0.00000'
    else:
        # paramdict['mass'][vlq_ids[runArgs.vlqmode]] = str(runArgs.mass)
        # paramdict['decay'][vlq_ids[runArgs.vlqmode]] = str(runArgs.gamma)
        ...
        # paramdict['k'+runArgs.vlqmode.lower()+chiralityIndex.lower()+'w']['K' + runArgs.vlqmode + chiralityIndex + 'w2'] = '0.00000'
        # paramdict['k'+runArgs.vlqmode.lower()+chiralityIndex.lower()+'z']['K' + runArgs.vlqmode + chiralityIndex + 'z2'] = '0.00000'
        # paramdict['k'+runArgs.vlqmode.lower()+chiralityIndex.lower()+'h']['K' + runArgs.vlqmode + chiralityIndex + 'h2'] = '0.00000'
        # paramdict['k'+runArgs.vlqmode.lower()+chiralityIndex.lower()+'w']['K' + runArgs.vlqmode + chiralityIndex + 'w1'] = '0.00000'
        # paramdict['k'+runArgs.vlqmode.lower()+chiralityIndex.lower()+'z']['K' + runArgs.vlqmode + chiralityIndex + 'z1'] = '0.00000'
        # paramdict['k'+runArgs.vlqmode.lower()+chiralityIndex.lower()+'h']['K' + runArgs.vlqmode + chiralityIndex + 'h1'] = '0.00000'
